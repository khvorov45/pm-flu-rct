...
I defined ILI to be any ILI event at any point during follow-up.

Model specification is in Eq.~\ref{eq:model-ili}. Interpretation of parameters
is in Table~\ref{tab:estimates-interpret-ili}
