...
\begin{figure}[htp]
    ...
    \caption{
        ...
        calculated using titre midpoints --- all measurements (except 5)
        were shifted to the geometric mean of the interval that the measurement
        is censored to.
        For example, a measurement recorded as "20" was shifted to the
        geometric mean between 20 and 40 for the
        purposes of calculating the group geometric mean.
    }
    \label{fig:spag}
\end{figure}
